 ...
 * @Package: com.weiwan.support.core.coprocessor.SqlCoprocessorChain
 * @ClassName: EtlStreamCoprocessorChain
 * @Description:
 **/
public class TableStreamCoprocessorChain<E, S1, S2> implements CoprocessorChain<E, S1, S2> {
    ...
    public TableStreamCoprocessorChain(E env, SupportDataFlow<E, S1, S2> dataFlow, Object obj) {
        this.env = env;
    ...
    private void initChain() {
        ...
        next = next.nextCoprocessor(new TableCoprocessor(context))
