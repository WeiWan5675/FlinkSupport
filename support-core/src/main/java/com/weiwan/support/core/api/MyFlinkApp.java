...
public class MyFlinkApp extends StreamAppSupport {
    ...
    @Override
    public DataStream openResource(StreamExecutionEnvironment env, SupportAppContext context) {
        return null;
    }

    @Override
    public DataStream streamProcess(DataStream inputStream) {
        return null;
    }

    @Override
    public DataStreamSink streamOutput(DataStream outputStream) {
        return null;
    }
