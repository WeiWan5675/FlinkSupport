...
@PrintToLog
@Checkpoint
public class TestConsoleCase extends StreamSupport<String, String> {

    public static void main(String[] args) throws Exception {
        SupportTestConsole build = SupportTestConsole.newBuilder().waitTestClass(TestConsoleCase.class).build();
        build.run();
    }
